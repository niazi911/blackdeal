...
def menu():
	...
	print(h+line)
	print(h+"\n{"+k+"01"+h+"}"+l+" Crack Dari Pertemanan Atau Publik")
...
def info():
    os.system('clear')
    banner()
    print("\n"+balmond+" Author : SPTTY-CHAN & AYU AMANDA")
    print(""+balmond+" Record : FENZ & JAPON")
    print(""+balmond+" Facebook : facebook.com/100006033517423 [SPTTY-CHAN]")
    print(""+balmond+" Facebook : facebook.com/100003517393036 [AYU AMANDA]")
    print(""+balmond+" Facebook : facebook.com/100026788095748 [FENZ]")
    #print(""+balmond+" Fanspage : facebook.com/")
    print(""+balmond+" Instagram : instagram.com/japon.xyz")
    print(""+balmond+" Version : v0.3")
    input("\n"+balmond+" Back")
    menu()
	...
	if len(berapa_d)==0:
		...
		for angka in berapa_d:
			...
			if dutt>3599:
				...
				dett = ditt[0]+"d"
	print(h+"\r{"+k+"Fenz"+h+"} "+l+"%s/%s OK:%s CP:%s %s[%s%s%s] [%s%s%s]"%(loop,len(id),len(ok),len(cp),h,k,persen,h,k,dett,h), end=' ');sys.stdout.flush()
